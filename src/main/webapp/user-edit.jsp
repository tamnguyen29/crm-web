        ...
        <div class="container-fluid">
            <div class="row bg-title">
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                    <h4 class="page-title" style="white-space: nowrap;">Cập nhật thông tin / <span>${editedUser.getFullName()}</span> </h4>
                </div>
            </div>
            <!-- /.row -->
            <!-- .row -->
            <div class="row">
                ...
                <div class="col-md-8 col-xs-12">
                    <div class="white-box">
                        <form class="form-horizontal form-material" action="<c:url value="/user/edit"/>" method="post" enctype='multipart/form-data'>
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="hidden" name="userId" value="${editedUser.getId()}">
                                </div>
                            </div>
                            <div class="form-group">
